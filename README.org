...
* About me
1) Hello👋, I'm Aniket Meshram @aniketgm. (The title above is read as Enig me, similar to the word, Enigma)
2) I love 🧡 making scripts/apps to avoid monotonous tasks. I hate doing repeated tasks (well who doesn't
   but the sad fact is people and organizations still do it. And they seldom do anything about it.
3) I love 🧡 listening to Music 🎶 and Podcasts 🎙🎧. My music genres depends on the mood I'm in, at that particular time. For e.g., When I'm happy, I'll be listening to pop/soft-rocks, etc.
